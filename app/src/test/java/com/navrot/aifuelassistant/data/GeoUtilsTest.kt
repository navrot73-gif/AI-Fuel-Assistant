...
/**
 * Тесты для [GeoUtils] — формулы Гаверсинуса для расчёта расстояний.
 *
 * Примечание: ранее этот файл назывался GasStationRepositoryTest, но фактически
 * тестировал только GeoUtils. Переименован, чтобы освободить имя для настоящего
 * GasStationRepositoryTest (см. GasStationRepositoryTestRobolectric).
 */
class GeoUtilsTest {
